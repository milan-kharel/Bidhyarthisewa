...
else
{
    ...
    else
    {
        ...
        else
        {
            ...
            $sql="INSERT INTO `post_item` (`item_name`,  `original_price`, `expected_price`, `item_description`, `item_picture1`, `item_picture2`, `item_picture3`,  `used`, `display`, `user_id`) VALUES('$bookname', '$ogpirce', '$exprice', '$description', '$filedestination1', '$filedestination2', '$filedestination3', 'N', 'Y', '$username')";
